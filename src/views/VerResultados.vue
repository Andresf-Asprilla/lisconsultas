    ...
    <div class="container">
      ...
      <div class="card mx-4 mx-md-5 shadow-5-strong" style="margin-top: -100px; background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
        <div class="card">
          ...
          <div class="card-body">
            <div class="mb-4">
              <h5>Resultados de usuario con id: <span class="fw-normal">{{ this.$route.params.id }}</span></h5>
              <p><strong>Nombre y apellidos:</strong> <span class="fw-normal">{{ this.user.name + " " + this.user.lastname }}</span></p>
              <p><strong>Documento:</strong> <span class="fw-normal">{{ this.user.doc }}</span></p>
              <p><strong>Eps id:</strong> <span class="fw-normal">{{ this.user.eps }}</span></p>
              <p><strong>Género:</strong> <span class="fw-normal">{{ this.user.gender }}</span></p>
              <p><strong>Edad:</strong> <span class="fw-normal">{{ this.user.age }}</span></p>
            </div>
